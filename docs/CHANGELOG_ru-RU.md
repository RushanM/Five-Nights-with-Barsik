...
Сначала пишется полное название обновления, а потом через тире дата его анонса.

## Открытое обновление 2.4 — дата неизвестна
...
* переделано и исправлено поведение кое-какого врага, который сильно доставлял хлопот на седьмой ночи;
...
* коды были перенесены в меню дополнительного контента, которое теперь открыто с самого начала;
* коллекционируемый контент меню дополнительно контента был временно убран в связи с возникшими проблемами. Теперь меню дополнительного контента служит только доступом к кодам;
...
* теперь экран темнеет в два раза медленнее, когда одета маска;
* удалён изумрудный кот, потому что это странная затея.
  
## 2.3.3 — 11 февраля 2018, 0:12

* в меню дополнительного контента был изменён текст;
* добавлен новый код;
* игра облегчена;
* Изменён один исход кода;
* Изменён режим отображения игры в мобильной версии;
* исправлен баг, когда субтитры не исчезали, а оставались всю ночь;
* Исправлен баг, когда субтитры не исчезали, а оставались всю ночь;
* исправлен перевод меню дополнительного контента в украинской локализации;
* исправлен профиль персонажа ??? в “Дополнительно”;
* маленько изменилась маска;
* новая музыка в меню кодов;
* новый дизайн кнопок в ночи;
* новый дизайн меню кодов;
* теперь “Дополнительно” в меню имеет переводы и на других языках;
* Теперь “Дополнительно” появляется после прохождения 7 ночи;
...
* исправлен профиль персонажа ??? в «Дополнительно»;
* Исправлен профиль персонажа ??? в Дополнительно;
* на ПК версии теперь Дополнительно появляется после 7 ночи;
* На ПК версии теперь Дополнительно появляется после 7 ночи;
* совсем немного изменена маска;
* Совсем немного изменена маска;
* теперь Дополнительно переведено и на другие языки в меню;
* Теперь Дополнительно переведено и на другие языки в меню;
* Удалён Изумрудный Барсик.
* удалён изумрудный кот.
...
* В меню теперь предупреждение об удалении сохранений игры стоит на слой выше чем весь текст;
...
* Добавлено предупреждение об недоработанности функции «Ночи» в «Дополнительно».
...
* из предупреждения убрана предосторожность, так как игра собирается быть официально выложена в Trashbox;
...
* Исправление багов со звуком и анимациями;
* Переделаны скримеры;
...
* Так же обновлена Android версия.
...
* Новый враг, которой должен был быть в версии 2.0;
* Добавлено 2 новых пасхалок;
* Исправление багов;
* Сложность игры усложнена.
...
* Добавлен русский язык и исправлены ошибки на английском языке;
* Обновлен дизайн игры;
...
* Изменен HUD;
* Многие звуки и музыка изменены;
* Исправлен ИИ всех антагонистов;
* Исправлены баги.

---

Дальнейшие изменения есть ВКонтакте и на Game Jolt.
