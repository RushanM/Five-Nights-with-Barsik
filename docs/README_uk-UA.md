...
<p align="center">
  <img src="/assets/sprites/icons/uk-UA/repo_icon.png" alt="Значок репозиторію з текстом «П'ять ночей з Барсіком»" width="200" />
</p>
...
* [👾 спрайти](/assets/sprites/),
* [📖 документація](/docs/),
* [🌐 локалізації](/assets/l10n/),
