...
# choose se usa en el menú de selección de idioma como indicador de selección de idioma
choose = Seleccionar
...
# Botones simples en el menú. begin-game inicia la campaña de historia. codes lleva al menú de códigos.
# settings abre el menú de configuración. about abre el menú de información del juego. exit cierra el juego.

begin-game = Iniciar Juego
codes = Códigos
