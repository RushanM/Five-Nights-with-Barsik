...
# choose é usado no menu de seleção de idioma como indicador de seleção de idioma
choose = Selecionar
...
# Botões simples no menu. begin-game inicia a campanha da história. codes leva ao menu de códigos.
